...
public class Cart {
    ...
    private Book_HE163990 getBookById(int bid,List<Book_HE163990> list){
        for(Book_HE163990 i:list){
            if(i.getBid()==bid)
                return i;
        }
        return null;
    ...
    public Cart(String txt,List<Book_HE163990> list){
        items=new ArrayList<>();
        try{
        if(txt!=null && txt.length()!=0){
            ...
            for(String i:s){
                ...
                Book_HE163990 b=getBookById(bid, list);
