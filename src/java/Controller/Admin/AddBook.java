...
public class AddBook extends HttpServlet {
    ...
    throws ServletException, IOException {
        ...
        List<Book_HE163990> list = b.getAllBook();
        List<Category_HE163990> listC = b.getAllCategory();
        List<Publisher_HE163990> listP = b.getAllPublisher();

        try {
            Book_HE163990 book = b.getBook_HE163990ByBid(bid);
            if (book != null) {
